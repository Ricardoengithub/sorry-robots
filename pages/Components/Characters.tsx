          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col justify-between w-80 ml-12 h-48 items-left bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 p-6">
                ...
                <p className="flex justify-between text-xs">
                  <b>Episode: </b>
                  <i className='underline text-blue-600' onClick={(e) => setIDX(id)}>{episode[0].name}</i>
                </p>
                <p className="flex justify-between text-xs">
                  <b>Location: </b>
                  <i>{location.name}</i>
              ...
              <div onClick={(e) => setIDX(-1)} className="flex flex-col justify-between overflow-scroll overflow-x-hidden w-80 ml-12 h-48 items-left bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 p-6">
                <p className="flex justify-between text-xs">
                  <b>Name: </b>
                  <i>{episode[0].name}</i>
                </p>
                ...
                <ul>
                  ...
                  {episode[0].characters.map(((character: any) => <li className='text-xs'>- {character.name}</li>))}
                </ul>
